...
<div className="md:py-16 relative w-full overflow-hidden bg-gradient-to-br from-purple-100 via-[#F1E7FB] to-[#EFE2F8]">
  ...
  <div className="relative z-10 mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:py-28 lg:px-8">
    <div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-2">
      <div className="space-y-8">
        <div className="inline-flex font-roboto
        ...
        <div className="space-y-4">
          <h1 className="font-poppins text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-[#333333] animate-slide-up">
            Assess Your Skills,{" "}
            <span className="bg-gradient-to-r from-[#9B00FF] to-[#6300B3] bg-clip-text text-transparent animate-gradient">
              Build Your Career
            </span>
          </h1>
          <p className="font-roboto text-lg text-[#333333]/70 animate-slide-up animation-delay-200">
  ...
  <div className="relative z-10 flex justify-center
   pb-8 animate-bounce " >
    <div className="text-[#333333]/70 text-md font-extrabold font-poppins"
