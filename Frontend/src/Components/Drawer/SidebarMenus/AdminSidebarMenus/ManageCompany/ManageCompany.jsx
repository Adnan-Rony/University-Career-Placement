...
import { UseDeleteSingleCompanyByAdmin } from '../../../../../hooks/useAdmin'
                    ...
                    companies.map(company => <tr key={company._id}>
                      ...
                      <td className='flex flex-col justify-start items-start '>
                        ...
                        <span className="">
                          ...
                          Name: {company.createdBy.name}</span>
                      </td>
                      {/* 
      <td>
        ...
        <button className="text-red-500">Delete</button>
                      ...
                      <th>
                        ...
                        <div className="dropdown dropdown-center">
                          ...
                          <ul tabIndex={0} className="dropdown-content menu bg-r-background w-44
   rounded-box z-1 font-semibold p-2 shadow-sm">
                            <li><a>Trusted Partner</a></li>
                            <li><a>Top Recruiter</a></li>
                          </ul>
                        </div>
                      ...
                      <th>
                        <button onClick={() => handleDelete(company._id)} className="btn btn-ghost text-xl bg-red-50 text-red-700">
                          <MdDeleteOutline />
                        </button>
                      </th>
                    </tr>
