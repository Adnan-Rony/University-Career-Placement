      ...
      <div className="container mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            View and manage your professional portfolio
          </p>
        </div>
  ...
  View
        ...
        <div className="mt-6 bg-purple-50 border border-purple-200 rounded-xl p-5">
          ...
          <p className="text-sm text-purple-700">
            A complete portfolio increases your visibility to recruiters. Try to
            reach 100% completion by adding all relevant information.
          </p>
        </div>
      </div>
    </div>
