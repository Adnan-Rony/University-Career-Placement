...
import { createJob, deleteJob, getAllJobs, getAllJobsForAdmin, getJobById, getMyJobs, getRecommendedJobs, searchJobs, updateJob } from '../controllers/job.controller.js';
...
//For Admin
router.get("/admin/alljobs",getAllJobsForAdmin)
